...
class Model(nn.Module):
    ...
    __constants__ = ['densenet',
                     '_digit1', '_digit2', '_digit3', '_digit4', '_digit5', '_digit6', '_digit7', '_digit8', '_digit9',
                     '_digit10', '_digit11', '_digit12', '_digit13']

    def __init__(self):
        super(Model, self).__init__()
        self.densenet = models.densenet169(pretrained=False).features
        self._digit1 = nn.Sequential(nn.Linear(1664*9*9, 10))
        self._digit2 = nn.Sequential(nn.Linear(1664*9*9, 10))
        self._digit3 = nn.Sequential(nn.Linear(1664*9*9, 10))
        self._digit4 = nn.Sequential(nn.Linear(1664*9*9, 10))
        self._digit5 = nn.Sequential(nn.Linear(1664*9*9, 10))
        self._digit6 = nn.Sequential(nn.Linear(1664*9*9, 10))
        self._digit7 = nn.Sequential(nn.Linear(1664*9*9, 10))
        self._digit8 = nn.Sequential(nn.Linear(1664*9*9, 10))
        self._digit9 = nn.Sequential(nn.Linear(1664*9*9, 10))
        self._digit10 = nn.Sequential(nn.Linear(1664*9*9, 10))
        self._digit11 = nn.Sequential(nn.Linear(1664*9*9, 10))
        self._digit12 = nn.Sequential(nn.Linear(1664*9*9, 10))
        self._digit13 = nn.Sequential(nn.Linear(1664*9*9, 10))
